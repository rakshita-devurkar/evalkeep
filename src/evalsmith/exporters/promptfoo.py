...
from evalsmith.regression import Expectation, ExpectationType, RegressionTest
...
def build_config(
    ...
    *,
    ...
    return {
        "description": description or f"evalsmith suite against {target.target_id}",
        "providers": [provider_for(target, project_root=project_root, config_dir=config_dir)],
        # The prompt is the test input verbatim: Evalsmith tests an application,
